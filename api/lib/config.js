...
module.exports = (function() {
  ...
  if (process.env.NODE_ENV === 'test') {
    ...
    config.featureToggles.isPoleEmploiEnabled = false;
    config.featureToggles.myAccount = false;
    ...
    config.graviteeRegisterApplicationsCredentials = [
      ...
      { clientId: 'graviteeOsmoseClientId', clientSecret: 'graviteeOsmoseClientSecret', scope: 'organizations-certifications-result', source: 'lsl' },
    ];
