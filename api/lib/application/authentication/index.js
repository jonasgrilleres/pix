      ...
      config: {
        ...
        validate: {
          payload: Joi.object().required().keys({
            ...
            clientId: Joi.string().required().description('Client identification'),
            clientSecret: Joi.string().required().description('Client secret for the corresponding identification'),
